                ...
                {orgs?.filter(o => o.status === 'PENDING').map(org => (
                  <tr key={org.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-8 py-4 text-right space-x-3">
                      ...
                      <button onClick={() => approveMutation.mutate({ id: org.id, type: org.type, notes: 'Direct approval from dashboard' }, {
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-4">
                  <Button
                    ...
                    onClick={() => {
                      rejectMutation.mutate({ id: selectedOrg.id, type: selectedOrg.type, reason: adminRemark || 'AUDIT_FAILED' }, {
                        onSuccess: () => {
